	var codigo_do_software = "Mt_fin";
	var nome_do_software = "Como comprar sua moto";
	...
	var FichaTecnica = $H({
		...
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Neste software, o estudante simulará a compra de uma moto. Para isso, primeiramente será preciso guardar dinheiro na poupança e, depois, esse valor será dado como entrada na compra da moto. O restante do preço será ﬁnanciado. Para facilitar os cálculos dessa aquisição, serão necessários alguns conceitos de Progressão Geométrica.'
		},
		conteudos: {
			titulo: 'Conteúdo',
		...
		objetivos: {
			titulo: 'Objetivos',
			conteudo: 'Aplicar o conceito de juros compostos; Introduzir o conceito de empréstimo sob juros; Mostrar aplicações de progressão geométrica em matemática ﬁnanceira.'
		},
		duracao: {
			titulo: 'Duração',
